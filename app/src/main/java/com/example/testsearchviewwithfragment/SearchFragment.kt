...
class SearchFragment : Fragment() {
    ...
    val mAllValues: MutableList<String> = mutableListOf()

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        val name = this.javaClass.canonicalName
        Log.d("omCreate", "We Create now fragment $name")
...
//        mAdapter = ArrayAdapter<Any?>(mContext, android.R.layout.simple_list_item_1, mAllValues)
